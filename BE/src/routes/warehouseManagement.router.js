...
import { createWarehouse, deleteWarehouse, getAllWarehouses, searchWarehouse, updateWarehouse } from '../controllers/warehouseManagement.controllers.js';

const warehouseManagementRoutes = express.Router();

warehouseManagementRoutes.get(`/get_all_warehouses`,getAllWarehouses);
warehouseManagementRoutes.get(`/search_warehouse`,searchWarehouse);
